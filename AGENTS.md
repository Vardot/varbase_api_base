...
Guidance for AI coding agents working on the Varbase API Base recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_api_base](https://git.drupalcode.org/project/varbase_api_base/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_api_base](https://www.drupal.org/project/issues/varbase_api_base)
